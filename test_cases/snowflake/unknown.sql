...
CREATE OR REPLACE VIEW DISPUTE_PVC_MODEL_INFERENCE_VIEW
    COMMENT ='[Alex] Inference dataset for v0.1 dispute pvc model'
    as
    WITH recent_disputes AS (
     SELECT
      ...
      WHERE created_at::date>='2020-12-09' AND  created_at::date<'2020-12-10'
    ),
